...
Since this uses Floats, there is a floating point overflow when limit is over 308.
'''
...
def fib(index):
    return int((phi ** index - upsilon ** index) / root5)
...
import utils.timing
utils.timing.table_timing([308], count, scale)
