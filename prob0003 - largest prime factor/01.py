...
import utils.timing
utils.timing.table_timing([13195, 4000001], count, scale)
utils.timing.plot_timing([100000001, 200000003, 300000001, 400000001, 500000003, 600000001, 700000001, 800000003, 900000001, 1000000001], count, scale)