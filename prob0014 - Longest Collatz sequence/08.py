...
Use memoization + only examine top half + skip step for odd values
'''
...
def collatz_length(n):
    ...
    if n not in memo:
        if n % 2 > 0:
            memo[n] = collatz_length((3 * n + 1) // 2) + 2
        else:
...
utils.timing.plot_timing([100000, 200000, 300000, 400000, 500000, 600000, 700000, 800000, 900000, 1000000], count, scale, "prob0014.08")