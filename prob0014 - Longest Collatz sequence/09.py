...
Use the library implementation for memoization, so we don't have to roll our own + only check top half + odds skip a step
'''
...
utils.timing.plot_timing([100000, 200000, 300000, 400000, 500000, 600000, 700000, 800000, 900000, 1000000], count, scale, "prob0014.09")