...
Brute force - recursive definition with optimzation that odd numbers can skip a step, and only examine top half
'''
...
utils.timing.plot_timing([200000, 400000, 600000, 800000, 1000000], count, scale, "prob0014.05")